...
def load_data(args):
    ...
    image_list, label_list = LUMINA_BIRADS(root = args.data_path, classes = args.classes)
...
if __name__ == "__main__":
    ...
    args.output_dir = os.path.join(args.output_dir, args.model+'_'+str(args.input_size)+'_'+str(args.classes), 'fold'+str(args.fold))
